...
int runSimulation(struct TokenRingData *simulationData, int numPackets, pthread_t *threads);
int cleanupSystem(struct TokenRingData *simulationData, pthread_t *threads);
